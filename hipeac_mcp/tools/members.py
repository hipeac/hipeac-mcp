...
async def search_members(
    ...
    **Mandatory workflow**:
    ...
    :param query: Text search on person names and usernames only — do NOT use this for research topics or areas.
    ...
    :param limit: Maximum number of results to return (min: 1, max: 100).
